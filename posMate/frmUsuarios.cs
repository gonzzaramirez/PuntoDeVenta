...
namespace CapaPresentacion
{
    public partial class frmUsuarios : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            // Puedes agregar una validación de rango si es necesario

            // Resto del código para crear o editar el usuario
        ...
        {
            dgvData.Rows.Clear(); // Limpia las filas existentes en el DataGridView
